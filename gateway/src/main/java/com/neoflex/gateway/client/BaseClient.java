...
public class BaseClient {
    ...
    protected ResponseEntity<Object> put(String path, Map<String, Object> parameters) {
    ...
    private <T> ResponseEntity<Object> makeAndSendRequest(HttpMethod method, String path,
        ...
        ResponseEntity<Object> conveyorServerResponse;
        try {
            if (parameters != null) {
                conveyorServerResponse = rest.exchange(path, method, requestEntity, Object.class, parameters);
            } else {
                conveyorServerResponse = rest.exchange(path, method, requestEntity, Object.class);
            }
        } catch (HttpStatusCodeException e) {
            return ResponseEntity.status(e.getStatusCode()).body(e.getResponseBodyAsByteArray());
        }
        return prepareGatewayResponse(conveyorServerResponse);
    }
